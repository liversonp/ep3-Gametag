...
class HomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post homes_url, params: { home: { descricao: @home.descricao, imagem: @home.imagem, nome: @home.nome } }
    end
  ...
  test "should update home" do
    patch home_url(@home), params: { home: { descricao: @home.descricao, imagem: @home.imagem, nome: @home.nome } }
